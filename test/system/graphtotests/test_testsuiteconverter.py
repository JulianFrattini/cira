...
@pytest.fixture
def sentence(id: str):
    _, sentence, _, graph, testsuite = load_sentence(filename=f'{constants.SENTENCES_PATH}/sentence{id}.json')
    return {
        'text': sentence,
        'graph': graph,
        'testsuite': testsuite
...
def test_system(sentence):
    ...
    parameters:
        sentence -- parametrized fixture, containing a 'graph' and an expected 'testsuite'
    """
