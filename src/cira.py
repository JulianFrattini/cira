...
if __name__ == "__main__":
    sentence = "If a fire breaks out in the building and either no firemen are around or the people start to panic, the building needs to be evacuated."
